...
(function() {
  $(function() {
    var $charStats, $completed, $current, $dash, $game, $path, charSource, checkOffQuest, dailyTimer, dashSource, handleChar, handleDash, handlePath, pathSource, questTimerUpdate, socket, updateCharBars, updateDashboard;
    socket = io.connect();
    ...
    socket.on('updateChar', function(character) {
      ...
      $('#experienceProgressbar').progressbar({
        value: character.expPerc
      });
      $('#experienceProgressbar').find('.ui-progressbar-value').css({
        'background': '#660066'
      });
      $('#healthProgressbar').progressbar({
        value: character.hpPerc
      });
      return $('#healthProgressbar').find('.ui-progressbar-value').css({
        'background': '#F13939'
      });
