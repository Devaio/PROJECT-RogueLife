...
(function() {
  var Character, GoogleStrategy, LocalStrategy, MongoURI, app, client, express, fs, http, io, ip, moment, mongoose, passport, path, pathTasks, routes, server, socketUpdateChar, user, _ref, _ref1;
    ...
    socket.on('damage', function(data) {
      ...
      return Character.findOne({
        ...
        char['dailies'].forEach(function(daily) {
          console.log(daily);
          return daily.startDaily = moment().format('X');
        });
