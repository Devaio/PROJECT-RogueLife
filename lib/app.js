...
(function() {
  var Character, GoogleStrategy, LocalStrategy, MongoURI, app, express, fs, http, io, localURL, moment, mongoose, passport, path, pathTasks, prodURL, realmset, returnURLset, routes, server, socketUpdateChar, user, _ref;
