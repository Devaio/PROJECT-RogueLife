...
(function() {
  var Character, GoogleStrategy, LocalStrategy, MongoURI, app, client, express, fs, http, io, ip, moment, mongoose, passport, path, pathTasks, routes, sendgrid, server, socketUpdateChar, user, _ref, _ref1;
