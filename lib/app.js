...
(function() {
  var Character, GoogleStrategy, LocalStrategy, MongoURI, app, express, fs, http, io, ip, moment, mongoose, passport, path, pathTasks, routes, server, socketUpdateChar, user, _ref, _ref1;
