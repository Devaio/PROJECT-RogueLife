...
(function() {
  var Character, GoogleStrategy, LocalStrategy, MongoURI, app, express, fs, http, io, moment, mongoose, passport, path, pathTasks, routes, server, socketUpdateChar, user, _ref;
  ...
  io.sockets.on('connection', function(socket) {
    ...
    return socket.on('finishDaily', function(data) {
      Character.update({
        username: data.user.username
      }, {
        $pull: {
          dailies: data.questName
        }
      }, function(err, char) {});
      return socketUpdateChar(data, socket);
    });
