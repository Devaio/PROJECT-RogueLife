...
(function() {
  var Character, LocalStrategy, MongoURI, SteamStrategy, app, express, fs, http, io, moment, mongoose, passport, path, pathTasks, routes, server, steamKey, user, _ref;
  ...
  app.get('/auth/steam/return', passport.authenticate('steam', {
    ...
    return res.redirect('/getsteaminfo');
  });

  app.get('/getsteaminfo', function(req, res) {});
